...
#include <aoi/refresher/sq_fitting/include/SQ_utils.h>
#include <aoi/refresher/sq_fitting/include/SQ_fitter.h>
#include <aoi/refresher/tabletop_symmetry/mindGapper.h>
...
void fit_REV( std::vector<pcl::PointCloud<pcl::PointXYZRGBA>::Ptr > _clusters );
void fit_EXT( std::vector<pcl::PointCloud<pcl::PointXYZRGBA>::Ptr > _clusters );
...
int main( int argc, char* argv[] ) {
	...
	switch(c) {
	case 'r': { mFilename = std::string(optarg); } break;
