...
/**
 * @function thresholdDepth
 * @brief Use a PassThrough filter to remove points with depth values that are too large or too small 
 */
...
/**
 * @function downsample
 * @brief  Use a VoxelGrid filter to reduce the number of points 
 */
