/**
 * @file SQ_fitter_evaluated.hpp
 * @brief Implementation to compare diverse functions using the mirroring approach
 */
#pragma once
 ...
 */
template<typename PointT>
void SQ_fitter_evaluated<PointT>::setInputCloud( const PointCloudPtr &_cloud ) {
  cloud_ = _cloud;
}
 ...
 */
template<typename PointT>
void SQ_fitter_evaluated<PointT>::setInitialApprox( const Eigen::Isometry3d &_Tsymm,
 ...
 */
template<typename PointT>
bool SQ_fitter_evaluated<PointT>::fit( const int &_type,
				       const double &_smax,
				       const double &_smin,
				       const int &_N,
 ...
 */
template<typename PointT>
void SQ_fitter_evaluated<PointT>::getBoundingBox(const PointCloudPtr &_cloud,
						 double _dim[3],
						 double _trans[3],
						 double _rot[3],
						 bool _debug ) {
 ...
 */
template<typename PointT>
void SQ_fitter_evaluated<PointT>::downsample( const PointCloudPtr &_cloud,
 ...
 */
template<typename PointT>
bool SQ_fitter_evaluated<PointT>::minimize( const int &_type,
 ...
 */
template<typename PointT>
void SQ_fitter_evaluated<PointT>::printResults() {
