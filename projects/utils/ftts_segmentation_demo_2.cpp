/**
 * @file ftts_segmentation_demo_2.cpp
 * @brief Demo of tabletop segmentation + bounding box
 * @brief NOTICE WE ARE NOT USING MUTEXES AS WE ONLY HAVE A SINGLE CALLBACK AND NO INTERRUPTIONS
 * @date 2016/01/13
 */
...
// Global variables
std::string gWindowName = std::string("Demo 2");
