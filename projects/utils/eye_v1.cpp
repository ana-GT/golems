...
void setRevolute( int state, void* userData );
void setExtrusion( int state, void* userData );
void fit( int state, void* userData );
...
int main( int argc, char* argv[] ) {
  ...
  cv::createButton( "Superquadric", setSQ,
		    NULL, cv::QT_RADIOBOX,
		    false );
  cv::createButton( "Revolute", setRevolute,
		    NULL, cv::QT_RADIOBOX,
		    false );
  cv::createButton( "Extrusion", setExtrusion,
		    NULL, cv::QT_RADIOBOX,
		    false );

  cv::createButton( "Fit", fit, 
		    NULL, cv::QT_PUSH_BUTTON,
		    false );
...
void setRevolute( int state, void* userData ) { mPrimFlag = REVOLUTE_FLAG; }
void setExtrusion( int state, void* userData ) { mPrimFlag = EXTRUSION_FLAG; }
...
void fit( int state, void* userData ) {
  ...
  case BB_FLAG:
    printf("\t * Fitting bounding boxes \n");
    break;
  case SQ_FLAG:
    printf("\t * Fitting superquadrics \n");
    break;
  case REVOLUTE_FLAG:
    printf("\t * Fitting revoluted surfaces \n");
    break;
  case EXTRUSION_FLAG:
    printf("\t * Fitting extrusion surfaces \n");
    break;
  };
